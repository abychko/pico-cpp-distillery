...
// OOPS! It is too full, empty it NOW
  if(_bufferIn>=BUFFER_LENGTH-4-(_last_mode==mode?0:1)) show();
...
// set ram address
  send_byte(LCD_SETCGRAMADDR | charnum << 3, LCD_COMMAND, true);
...
// Make the I2C pins available to picotool
  ...
  int i2c_speed = i2c_init(I2C, I2C_Clock);
